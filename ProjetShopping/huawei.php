...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class=" collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="panierhuawei.php">
                            <i class="fas fa-shopping-cart"></i>Panier<span><?=array_sum($_SESSION['panier_huawei'])?></span>
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="px-lg-5">
            <div class="row py-5">
                <div class="col-lg-12 mt-5">
                    <div class="text-white p-5 shadow-sm rounded banner">
                        ...
                        <br>
                            Quel modèle Apple-Iphone acheter en 2023 ?
                        </p>
                    </div>
                </div>
            </div>
            ...
            $requette =mysqli_query($conn,"SELECT * FROM panierhuawei");
            ...
            ?>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                    <div class="bg-white rounded shadow-sm"><img src="images/<?=$resultat["img"]?>" alt=""
                        ...
                        <div class="p-4">
                            <p><?=$resultat["nom"]?></p>
                            <a href="ajouterhuawei.php?id=<?=$resultat["id_huawei"]?>"class="btn btn-primary btn-lg" role="button" aria-disabled="true">Ajouter au
                                Panier</a>
                                <p><?=$resultat["prix"]?>£</p>
