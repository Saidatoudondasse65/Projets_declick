...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class=" collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="panieriphone.php">
                            <i class="fas fa-shopping-cart"></i>Panier<span><?=array_sum($_SESSION['panier_iphone'])?></span>
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="px-lg-5">
            ...
            $requette =mysqli_query($conn,"SELECT * FROM panieriphone");
            ...
            ?>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                    <div class="bg-white rounded shadow-sm"><img src="images/<?=$resultat["img"]?>" alt=""
                        ...
                        <div class="p-4">
                            <p><?=$resultat["nom"]?></p>
                            <a href="ajouteriphone.php?id=<?=$resultat["id_iphone"]?>"class="btn btn-primary btn-lg" role="button" aria-disabled="true">Ajouter au
                                Panier</a>
                                <p><?=$resultat["prix"]?>£</p>
