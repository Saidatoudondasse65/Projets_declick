<?php
   ...
   if(isset($valider)){
      ...
      elseif($pass!=$repass) $erreur="Mots de passe non identiques!";
         ...
         $requete = $conn->prepare("SELECT id FROM administration WHERE login=? LIMIT 1");
         ...
         if(count($tab)>0)
          ...
          $requete = $conn->prepare("INSERT INTO administration (nom, prenom, login, pass) VALUES (?, ?, ?, ?)");
          $requete->bind_param("ssss", $nom, $prenom, $login, md5($pass));
          $requete->execute();
...
<html>
   ...
   <body>
      ...
      <form name="fo" method="post" action="">
         ...
         <input type="login" name="login" placeholder="Login" value="<?php echo $login?>" /><br />
